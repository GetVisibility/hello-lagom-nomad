package com.getvisibility.hellolagomnomad.api
...
object HellolagomnomadService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The hello-lagom-nomad service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellolagomnomadService.
  */
trait HellolagomnomadService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("hello-lagom-nomad")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(HellolagomnomadService.TOPIC_NAME, greetingsTopic)
